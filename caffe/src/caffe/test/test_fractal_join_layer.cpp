...
TYPED_TEST(FractalJoinLayerTest, TestSetUpDropPathGlobal)
{
    typedef typename TypeParam::Dtype Dtype;
    LayerParameter layer_param;
    FractalJoinParameter* fractal_join_param = layer_param.mutable_fractal_join_param();
...
TYPED_TEST(FractalJoinLayerTest, TestMeanGlobal)
{
    typedef typename TypeParam::Dtype Dtype;
    LayerParameter layer_param;
    FractalJoinParameter* fractal_join_param = layer_param.mutable_fractal_join_param();
    ...
    const Dtype* in_data_a = this->blob_bottom_a_->cpu_data();
    for (int i = 0; i < count; ++i) {
        EXPECT_NEAR(data[i], in_data_a[i], 1e-4);
    }
}
...
TYPED_TEST(FractalJoinLayerTest, TestMeanGradientGlobal)
{
    typedef typename TypeParam::Dtype Dtype;
    LayerParameter layer_param;
    this->blob_bottom_d_->SetGlobalDrop (true);
...
TYPED_TEST(FractalJoinLayerTest, TestMeanDropPathGradientGlobal)
{
    typedef typename TypeParam::Dtype Dtype;
    LayerParameter layer_param;
    FractalJoinParameter* fractal_join_param = layer_param.mutable_fractal_join_param();
...
TYPED_TEST(FractalJoinLayerTest, TestSum)
{
    typedef typename TypeParam::Dtype Dtype;
    LayerParameter layer_param;
    FractalJoinParameter* fractal_join_param = layer_param.mutable_fractal_join_param();
...
TYPED_TEST(FractalJoinLayerTest, TestSumNotAll)
{
    typedef typename TypeParam::Dtype Dtype;
    LayerParameter layer_param;
    FractalJoinParameter* fractal_join_param = layer_param.mutable_fractal_join_param();
    ...
    const Dtype* in_data_c = this->blob_bottom_c_->cpu_data();
    for (int i = 0; i < count; ++i) {
        EXPECT_NEAR(data[i], in_data_a[i] + in_data_c[i], 1e-4);
    }
}

TYPED_TEST(FractalJoinLayerTest, TestSumGlobal)
{
    typedef typename TypeParam::Dtype Dtype;
    LayerParameter layer_param;
    FractalJoinParameter* fractal_join_param = layer_param.mutable_fractal_join_param();
...
TYPED_TEST(FractalJoinLayerTest, TestSumGradient)
{
    typedef typename TypeParam::Dtype Dtype;
    LayerParameter layer_param;
    FractalJoinParameter* fractal_join_param = layer_param.mutable_fractal_join_param();
...
TYPED_TEST(FractalJoinLayerTest, TestSumGradientGlobal)
{
    typedef typename TypeParam::Dtype Dtype;
    LayerParameter layer_param;
    FractalJoinParameter* fractal_join_param = layer_param.mutable_fractal_join_param();
...
TYPED_TEST(FractalJoinLayerTest, TestSumDropPathGradient)
{
    typedef typename TypeParam::Dtype Dtype;
    LayerParameter layer_param;
    FractalJoinParameter* fractal_join_param = layer_param.mutable_fractal_join_param();
...
TYPED_TEST(FractalJoinLayerTest, TestSumDropPathGradientGlobal)
{
    typedef typename TypeParam::Dtype Dtype;
    LayerParameter layer_param;
    FractalJoinParameter* fractal_join_param = layer_param.mutable_fractal_join_param();
